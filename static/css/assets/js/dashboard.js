(function($) {
  ...
  $(function() {
    ...
    if ($("#visit-sale-chart").length) {
      ...
      var totalsale = JSON.parse(document.getElementById('totalsale').textContent);
      var totalpurchase = JSON.parse(document.getElementById('totalpurchase').textContent);
    ...
    if ($("#traffic-chart").length) {
      ...
      var todaysale = JSON.parse(document.getElementById('todaysale').textContent);
      var todaypurchase = JSON.parse(document.getElementById('todaypurchase').textContent);
